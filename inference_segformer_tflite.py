# /**
#  * @file inference_segformer_tflite.py 
...
if __name__ == '__main__':
    ...
    log_path = r'logs/inference-segformer-tflite' + os.sep + datetime.now().strftime('%Y-%m-%d-%H-%M-%S') + '.log'
    os.makedirs(r'logs/inference-segformer-tflite', exist_ok=True)
    ...
    for video_file in os.listdir(DATA_DIR):
        ...
        while True:
            ...
            # Predicting the mask.
            model.set_tensor(input_details['index'], tf.expand_dims(frame, 0))
            ...
            pred_mask = tf.squeeze(prediction)
