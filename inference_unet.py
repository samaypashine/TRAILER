...
if __name__ == '__main__':
    ...
    log_path = r'logs/inference-unet' + os.sep + datetime.now().strftime('%Y-%m-%d-%H-%M-%S') + '.log'
    os.makedirs(r'logs/inference-unet', exist_ok=True)
    ...
    for video_file in os.listdir(DATA_DIR):
        ...
        while True:
            ...
            prediction = prediction.astype(float) / prediction.max()
